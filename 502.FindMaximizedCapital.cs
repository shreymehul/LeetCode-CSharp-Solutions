...
public class Solution {
    public int FindMaximizedCapital(int k, int w, int[] profits, int[] capital) {
        //minHeap for project with minimum capital
        PriorityQueue<(int capital, int profit), int> minHeap = new();
        //maxHeap for project with maximum profit
        ...
        for(int i = 0; i < k; i++){
            //Move all prject that can be done with current capital
